...
import static edu.aku.hassannaqvi.tpvicsshrucround2listing.core.MainApp.TAJIKISTAN;
import static edu.aku.hassannaqvi.tpvicsshrucround2listing.core.MainApp.editor;
import static edu.aku.hassannaqvi.tpvicsshrucround2listing.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.tpvicsshrucround2listing.database.CreateTable.DATABASE_COPY;
...
import edu.aku.hassannaqvi.tpvicsshrucround2listing.MainActivity;
...
import edu.aku.hassannaqvi.tpvicsshrucround2listing.core.AppInfo;
...
import edu.aku.hassannaqvi.tpvicsshrucround2listing.databinding.ActivityLoginBinding;
 ...
 /*            countryCode = getCountryCode(this);
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.tpvicsshrucround2listing.ui.SyncActivity.class).putExtra("login", true));
        } else {
